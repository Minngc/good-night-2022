...
function LoginCard(props: any) {
  ...
  const feishuLogin = () => {
    //TODO 线上版本要更换链接
    window.location.href = 'https://passport.feishu.cn/suite/passport/oauth/authorize?client_id=cli_a328c11558fc100c&redirect_uri=https%3A%2F%2Fgoodnight2022.sast.fun%2Ffsre&response_type=code&state=feishuLogin'
    ...
    <div className='loginBox'>
      <div className="container">
        <div className="box">
          ...
          <div style={{ height: '20px', margin: '10px', marginTop: '30px', fontSize: '18px' }}>合作平台登录</div>
          <button onClick={qqLogin} style={{background:'#1fbafb'}}> 使用 QQ 登录 </button>
          <div>
          </div>
        </div>
      </div>
